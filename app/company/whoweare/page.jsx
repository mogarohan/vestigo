...
export default function CompanyOverview() {
  ...
  return (
    <main ref={containerRef} className="bg-white overflow-hidden">
      ...
      {/* 1. PREMIUM DARK HERO SECTION (Replaced) */}
      <section className="relative h-[85vh] flex items-center justify-center overflow-hidden bg-[#0F172A]">
        ...
        <motion.div style={{ y, opacity }} className="relative z-10 text-center px-6">
          ...
          <p className="text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed">
            Vestigo is more than insurance—it is your safety shield. 
            We turn uncertainty into opportunity through global expertise and innovative technology.
          </p>
